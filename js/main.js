...
console.log("☟︎︎⚐︎︎☹︎︎✌︎︎✏︎︎ ✡︎︎⚐︎︎🕆︎︎ ☞︎︎⚐︎︎🕆︎︎☠︎︎👎︎︎ 💣︎︎☜︎︎📪︎ ☟︎︎🕆︎︎☟︎︎✍︎︎ ✌︎︎☠︎︎✡︎︎🕈︎︎✌︎︎✡︎︎📪︎︎ 🏱︎︎✌︎︎💧︎︎💧︎︎🕈︎︎⚐︎︎☼︎︎👎︎︎ ☞︎︎⚐︎︎☼︎︎ 💧︎︎☜︎︎👍︎︎☼︎︎☜︎︎❄︎︎ 👍︎︎⚐︎︎💣︎︎💣︎︎✌︎︎☠︎︎👎︎︎ ✋︎︎💧︎︎ 🕯︎︎🗐︎✠︎☼︎📁︎🕯︎︎📬︎︎ ☟︎︎⚐︎︎🏱︎︎☜︎︎ ✡︎︎⚐︎︎🕆︎︎ 😐︎︎☠︎︎⚐︎︎🕈︎︎ 🕈︎︎☟︎︎✌︎︎❄︎︎ ✡︎︎⚐︎︎🕆︎︎🕯︎︎☼︎︎☜︎︎ 👎︎︎⚐︎︎✋︎︎☠︎︎☝︎︎✏︎︎ 💧︎☜︎☜︎ ✡︎✌︎✏︎  :)");
...
function commander(cmd) {
    switch (cmd.toLowerCase()) {
        ...
        case "cat":
            ...
            break;
        case "ll":
            loopLines(ll, "color2 margin", 80);
            break;
        case "rm":
            loopLines(rm, "color2 margin", 80);
            break;
        case "rm -rf /":
            loopLines(rm, "color2 margin", 80);
            break;
